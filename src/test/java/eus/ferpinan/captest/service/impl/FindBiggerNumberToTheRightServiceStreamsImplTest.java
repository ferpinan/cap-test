...
public class FindBiggerNumberToTheRightServiceStreamsImplTest {

    private FindBiggerNumberToTheRightServiceStreamsImpl service;

    @Before
    public void setUp() {
        service = new FindBiggerNumberToTheRightServiceStreamsImpl();
    }
